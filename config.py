...
WATCHLIST_METHOD = os.getenv("WATCHLIST_METHOD", "market_winners")
MAX_WATCHLIST_SIZE = _int_env("MAX_WATCHLIST_SIZE", 8)
USE_AI_INFRA_UNIVERSE = _bool_env("USE_AI_INFRA_UNIVERSE", True)

# Market Regime & Winners Tuning
REGIME_BEARISH_SIZE_MULTIPLIER = _float_env("REGIME_BEARISH_SIZE_MULTIPLIER", 0.5)
REGIME_NEUTRAL_SIZE_MULTIPLIER = _float_env("REGIME_NEUTRAL_SIZE_MULTIPLIER", 0.75)
REGIME_NEUTRAL_SL_TP_MULTIPLIER = _float_env("REGIME_NEUTRAL_SL_TP_MULTIPLIER", 0.75)
REGIME_BEARISH_SL_MULTIPLIER = _float_env("REGIME_BEARISH_SL_MULTIPLIER", 0.60)
MARKET_WINNERS_MIN_RELATIVE_STRENGTH = _float_env("MARKET_WINNERS_MIN_RELATIVE_STRENGTH", 1.0)
